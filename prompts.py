...
qa_chain_template = """Use the following sources to answer the question at the end. 
...
QA_CHAIN_PROMPT = PromptTemplate(template=qa_chain_template, input_variables=["summaries", "question"])
